...
Whenever a new release of RailOS is published, the scripts have to be updated with the new version number before building the new setup executables. Please note the `MyAppVersion` value.

## Building

The scripts are best built and modified using the [Inno Setup Compiler](https://jrsoftware.org/isinfo.php) (building was done with the latest v6.7.0). RailOS program files should be placed in the same directory as the script before running.
